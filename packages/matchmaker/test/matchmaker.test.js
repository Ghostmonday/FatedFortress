...
const createXp = (execution, collaboration, judgment, roleHistory = {}, successRate = {}, lastActivity = new Date()) => ({
...
describe('Matchmaker: formParty', () => {
    it('should form a complete party when sufficient users are available', () => {
        ...
        const state = {
            ['user1']: createXp(0, 100, 0, {}, {}, now), // Architect
            ['user2']: createXp(0, 0, 100, {}, {}, now), // Guardian
            ['user3']: createXp(100, 0, 0, {}, {}, now), // Builder 1
            ['user4']: createXp(100, 0, 0, {}, {}, now), // Builder 2
        };
    ...
    it('should calculate effective score with role multiplier', () => {
        ...
        const state = {
            ['user1']: createXp(100, 0, 0, roleHistory, {}, now),
        };
    ...
    it('should prioritize users with matching specialty', () => {
        const now = new Date('2023-01-01');
        const state = {
            ['specialist']: createXp(100, 0, 0, { 'BUILDER': { 'BACKEND': 10 } }, {}, now),
            ['generalist']: createXp(120, 0, 0, {}, {}, now),
        };
    ...
    it('should exclude inactive users (silent > 30 days)', () => {
        ...
        const state = {
            ['active']: createXp(100, 0, 0, {}, {}, activeDate),
            ['inactive']: createXp(100, 0, 0, {}, {}, inactiveDate),
        };
        const party = formParty(state, now);
    ...
    it('should apply success rate multiplier', () => {
        ...
        const state = {
            ['expert']: createXp(100, 0, 0, { 'BUILDER': { 'FRONTEND': 1 } }, successRate, now),
        };
    ...
    it('should pick best candidate for each role', () => {
        const now = new Date('2023-01-01');
        const state = {
            ['arch_pro']: createXp(0, 200, 0, {}, {}, now),
            ['arch_novice']: createXp(0, 50, 0, {}, {}, now),
            ['guard_pro']: createXp(0, 0, 200, {}, {}, now),
            ['guard_novice']: createXp(0, 0, 50, {}, {}, now),
        };
        const party = formParty(state, now);
...
//# sourceMappingURL=matchmaker.test.js.map