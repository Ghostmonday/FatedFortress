 ...
 */
export function calculateContributionXP(contribution, verdict = 'APPROVE') {
    if (verdict === 'REJECT')
        return 0;
 ...
 */
export function calculateVerificationXP(verification) {
 ...
 */
export function applyDecay(currentXP, daysSinceLastActivity) {
 ...
 */
export function calculateDecayRate(totalXP) {
